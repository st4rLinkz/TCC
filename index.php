...
<body>
        ...
        <header>
            <nav class="brutaltypenav">
                <div class="searchbar-bg">
                    ...
                    <div class="btImg" id="imagesHeader"><picture><img src="./images/icons/brutaltypeImg.jpg" alt=""></picture>
                    </div>
                    </div>
                    <div class="searchbar">
            ...
            <div class="navegação">
                ...
                <ul class="nav nav-underline">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link-disabled dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Masculino</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link-disabled dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Feminino</a>
                        <ul class="dropdown-menu">
                            <li><a class="" href="#">Camisetas</a></li>
                            <li><a class="" href="#">Calças</a></li>
                            <li><a class="" href="#">Jaquetas</a></li>
    ...
    <main>
        ...
        <h3 class="mt-3">Produtos Lançados <hr></h3>
                        ...
                        <div class="card" style="width: 22rem; margin-bottom: 40px;">
                            ...
                            <div class="card-body">
                                <a href="./infoProduto.php?id=<?php echo $row_produto['ID_PROD'] ?>" class="card-title">
                                    <h5><?php echo $row_produto['NOME_PROD']; ?></h5>
                                </a>
