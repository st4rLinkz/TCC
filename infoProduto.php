...
$row_product = $resultado_produtos->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
                ...
                <div class="navegação">
                    ...
                    <ul class="nav nav-underline">
                        <li class="nav-item dropdown">
                            <a class="nav-link-disabled dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                role="button" aria-expanded="false">Masculino</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link-disabled dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                role="button" aria-expanded="false">Feminino</a>
                            <ul class="dropdown-menu">
                                <li><a class="" href="#">Camisetas</a></li>
                                <li><a class="" href="#">Calças</a></li>
                                <li><a class="" href="#">Jaquetas</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link-disabled active" aria-current="page"
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <h1 itemprop="" class="" id="">
                    <?php echo $row_product['NOME_PROD'] ?>
                </h1>
                <h5 itemprop="" class="">
                    <?php echo $row_product['DESC_PROD'] ?>
                </h5>
                <h5 itemprop="" class="">R$
                    <?php echo number_format($row_product['VALOR_COMP_PROD'], 2, ",", ".") ?>
                </h5>
                <div class="ui two column grid">
                    <div class="column six wide mobile"></div>
                </div>
